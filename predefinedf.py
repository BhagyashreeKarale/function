...
unorder_list.sort()
print(unorder_list)#we cannot directly put unorder_list.sort() in print(it returns none).
# Output :- unorder_list = [0, 3, 4, 6, 7, 8, 9, 15, 34, 56] 
...
print(reverse_list)
# Output :- reverse_list = ["D", "R", "A", "M", "E", "B", "A", "A", "Z"] 
