...
# Yahan yeh function "Hello from NavGurukul ;)" print karega aur 120 ki value return karega. 
# Yeh 120 ki value "return number_sum" waali line ka use kar ke return karega.
# sum6 ki value 120 ho jayegi
# Pehli return number_sum waali line se neeche aapne jo bhi code likha hai 
# uss code mein se kuch bhi nahi chalega. 
# Yeh isliye nahi chalega kyunki function chalate hue jab python ko ek return statement milti hai, 
# toh python uss return statement ka use kar ke value return kar deta hai 
# aur fir uske neeche wala koi bhi code nahi chalata hai.
# Thodi aur depth mein jake mein function execution samajhte hain python mein. 
# Pehle iss code ko run kare bina samjahne ki try karo. Fir ek baar run kar ke dekho.
...
# * Yahan mon_menu mein "Butter Chicken" ki value hogi kyunki 
# humari if-elif-else statement yahan dekhti hai ki din "monday" diya hua hai toh "Butter Chicken" 
# return kar deti hai. 
# Jaise hi python ko return statement dikhti hai woh "Butter Chicken" return kar deti hai 
# aur function chalna banda ho jata hai. 
# Iss vajah se aakhir waali print command nahi chalti. 
# Kyunki uss print command se pehle hi humesha return statement ki vajah se 
# function chalna band ho jata hai

# Aise hi jab day ki value "tuesday" hoti hai toh return "Mutton Chaap" waali return statement 
# execute ho jati hai
# Aur jab "monday" aur "tuesday" dono hi nahi hote, 
# toh return "Chole Bhature" wali return statement execute ho jati hai.
# Lekin kyunki if-elif-else ke andar se hi return statement execute ho jaati hai, 
# humara program kabhi bhi aakhir wali if statement tak pahunchta hi nahi hai 
# aur woh kabhi print nahi hoti.
...
# Lekin jo akhri wali print statement hai woh nahi print hoyegi. 
# Kyunki uss print statement se pehle return statement chal jati hai 
# aur uski vajah se python needche walai print statement tak pahunchti hi nahi hai
